...
if __name__ == "__main__":
    ...
    os.mkdir('wafermap32/train') if not path.exists('wafermap32/train') else print('The folder(''wafermap32/train'') already exists.')
    os.mkdir('wafermap32/test') if not path.exists('wafermap32/test') else print('The folder(''wafermap32/test'') already exists.')
#    os.mkdir('wafermap32/val') if not path.exists('wafermap32/val') else print('The folder(''wafermap32/val'') already exists.')
    download_wafermap32()