...
def main():
    ...
    print(os.getcwd())
    train_data = np.load('./Defect_train_image_v1.npy')
    train_labels = np.load('./Defect_train_label_v1.npy')
    test_data = np.load('./Defect_test_image_v1.npy')
    test_labels = np.load('./Defect_test_label_v1.npy')
