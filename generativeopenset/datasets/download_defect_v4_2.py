...
# DEFECT_CLASSES = ['Array', 'Gap', 'Line', 'MicroScratch', 'Particle', 'Pattern', 'Pattern_con', 'Scratch', 'where', 'Cone']
...
def main():
    ...
    print(os.getcwd())
    train_data = np.load('./Defect_train_image_v4_2.npy')
    train_labels = np.load('./Defect_train_label_v4_2.npy')
    test_data = np.load('./Defect_test_image_v4_2.npy')
    test_labels = np.load('./Defect_test_label_v4_2.npy')
