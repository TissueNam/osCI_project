...
from networks import build_VGG_basic_network, build_WResNet_basic_network, get_optimizers_basic, get_lr_scheduler, save_basic_classification_networks
from options import load_options, get_current_epoch
from comparison import classifier_evaluate_with_comparison_basic
from evaluation import save_evaluation
from training import train_VGG_basic_classifier, train_basic_wresnet_classifier
...
networks = build_WResNet_basic_network(dataloader.num_classes, **options)
...
for epoch in range(start_epoch, start_epoch + options['epochs']):
    ...
    train_basic_wresnet_classifier(networks, optimizers, schedulers, dataloader, epoch=epoch, **options)
